def DerivativeSignal():
    ...
    for n in range(len(InputSignal)):
        if n > 0 and n < len(InputSignal)-1:
            ...
            FirstDrev.append(InputSignal[n]-InputSignal[n-1])
        # else:
        #     FirstDrev.append(InputSignal[len(InputSignal)-1])
        #     SecondDrev.append(InputSignal[len(InputSignal)-1])
    print("first")
    print(FirstDrev)
    print("second")
    print(SecondDrev)
